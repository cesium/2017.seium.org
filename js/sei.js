...
.controller('speakerCtrl',['$scope','$window','$rootScope',function($scope,$window,$rootScope){
     var speakers =
        ...
        [
            ...
            {pic:'img/speakers/rmachado.jpg', name:'Roberto Machado', position:'CEO' , enterprise:[{name:'Group Buddies',  enterpriseUrl:'https://groupbuddies.com/'}], web:'http://groupbuddies.com/' , twitter:'https://twitter.com/rmdgb', github:'https://github.com/rmdmachado',
            ...
            {pic:'img/speakers/mpalhas.jpg', name:'Miguel Palhas', position:'Developer & SysAdmin' , enterprise:[{ name:'Group Buddies',  enterpriseUrl:'https://groupbuddies.com/'}], web:'' , twitter:'https://twitter.com/Naps62', github:'https://github.com/naps62',
            ...
            {pic:'img/speakers/fcosta.jpg', name:'Francisco Costa', position:'CEO & Founder', enterprise:[{name:'Tricubo,',enterpriseUrl:'https://tricubo.com/'}, {name:'Chique,',enterpriseUrl:'https://chique.pt/'}, {name:'TYMR,',enterpriseUrl:'https://tymr.com/'}, {name:'Venture FC',enterpriseUrl:'https://venturefc.co/'}], web:'https://franciscocosta.com/' , twitter:'https://twitter.com/franciscocosta', github:'',
            ...
            {pic:'img/speakers/nhenriques.jpg', name:'Norberto Henriques', position:'Especialista de UX' , enterprise:[{name:'WeDo',enterpriseUrl:'http://www.wedotechnologies.com/pt/'}], web:'https://www.linkedin.com/in/norbertohenriques' , twitter:'', github:'',
            ...
            {pic:'img/speakers/nsousa.jpg', name:'Nuno Sousa', position:'Developer' , enterprise:[{name:'Bitreserve',enterpriseUrl:'https://bitreserve.org/'}], web:'' , twitter:'http://twitter.com/nunofgs', github:'https://github.com/nunofgs',
            ...
            {pic:'img/speakers/tribeiro.jpg', name:'Tiago Ribeiro', position:'Developer' , enterprise:[{name:'Bitreserve',enterpriseUrl:'https://bitreserve.org/'}], web:'http://tiagoribeiro.net/' , twitter:'https://twitter.com/_fixe', github:'https://github.com/fixe#_=_',
            ...
            {pic:'img/speakers/rmarinho.jpg', name:'Rui Marinho', position:'Developer' , enterprise:[{name:'Bitreserve',enterpriseUrl:'https://bitreserve.org/'}], web:'' , twitter:'https://twitter.com/ruipmarinho', github:'github.com/ruimarinho' ,
